document.addEventListener('DOMContentLoaded', () => {
  ...
  function renderTrending(products) {
    ...
    let trendingProducts = products && products.length >= 3 ? 
      [...products].sort((a, b) => b.rating.rate - a.rating.rate).slice(0, 3) :
      [
        { id: 101, title: "Leather Jacket", price: 99.99, category: "men's clothing", image: "https://via.placeholder.com/150", rating: { rate: 4.7, count: 120 } },
        { id: 102, title: "Wireless Earbuds", price: 59.99, category: "electronics", image: "https://via.placeholder.com/150", rating: { rate: 4.5, count: 80 } },
        { id: 103, title: "Diamond Ring", price: 199.99, category: "jewelery", image: "https://via.placeholder.com/150", rating: { rate: 4.9, count: 50 } }
      ];
  ...
  window.showDetails = async function (id) {
    try {
      ...
      modal.querySelector('#modal-rating').textContent = `⭐ ${product.rating.rate} (${product.rating.count})`;
